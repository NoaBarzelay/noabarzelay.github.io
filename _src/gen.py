  ...
  <main id="main">
    ...
    <section class="hero">
      <div class="hero-copy">
        ...
        <p class="hero-title">I love turning what AI makes possible into products people trust.</p>
...
{HERO_SVG}
    ...
    <section id="projects" class="block">
      ...
      <div class="cards">
        ...
        <article class="card">
          ...
          <p>Thesis Engine is my multi-agent research engine for investment theses. It takes a thesis, writes a falsifiable litmus test, decomposes the market into solution-oriented categories, and outputs a sourced report with a ranked list of potential investments.</p>
    ...
    <section id="experience" class="block">
      ...
      <div class="timeline">
        ...
        <div class="exp"><div class="exp-yr">2023&ndash;2025</div><div class="exp-body"><h3>Product Manager <span class="org">Wenrix</span></h3><p>Owned the core predictive-pricing platform (~60% of company revenue) and drove a +$2M annual revenue increase in 10 months.</p></div></div>
        <div class="exp"><div class="exp-yr">2020&ndash;2023</div><div class="exp-body"><h3>Software Engineer to Software Engineer II <span class="org">Microsoft</span></h3><p>Re-architected Defender for Endpoint's ML detection platform for hyperscale, cutting production errors from thousands per hour to tens.</p></div></div>
        <div class="exp"><div class="exp-yr">2014&ndash;2017</div><div class="exp-body"><h3>Aerial Operations Officer <span class="org">Israeli Air Force</span></h3><p>Directed real-time aircraft, helicopter, and UAV missions, collaborating with the US Air Force on joint counter-terrorism operations.</p></div></div>
        <div class="exp edu"><div class="exp-yr">2025&ndash;2026</div><div class="exp-body"><h3>MBA <span class="org">Columbia Business School</span></h3><p>GMAT 780 (99th percentile), Dean's List.</p></div></div>
        <div class="exp edu"><div class="exp-yr">2018&ndash;2022</div><div class="exp-body"><h3>BS, Computer Science and Economics <span class="org">Tel Aviv University</span></h3><p>Magna cum laude.</p></div></div>
      </div>
    </section>
    <section id="interests" class="block">
      <div class="block-head">
        <span class="idx">04</span><h2 class="block-title">Other Interests</h2><span class="rule"></span>
      </div>
      <div class="interests">
        <div class="int-group">
          <h3 class="int-label">Volunteering</h3>
          <ul class="int-list">
            <li>Lectured and mentored women entering STEM through Shavot at Microsoft, helping them break into tech and succeed in it.</li>
            ...
            <li>Summer camp counselor and fundraiser for children with cancer, through Larger Than Life.</li>
            <li>Summer camp counselor for children from difficult homes.</li>
          </ul>
        </div>
        <div class="int-group">
          ...
          <ul class="int-list">
            ...
            <li>Currently training for my first half marathon.</li>
            <li>Meditate daily, with a silent retreat every year.</li>
            <li>A lifelong reader. At ten I broke my local library's borrowing record with 143 books in a year. I still read constantly, non-fiction (a favorite is <em>A New Earth</em>) and fiction, especially science fiction and fantasy.</li>
            <li>Sol, my Vizsla and unofficial running coach, a velcro dog who treats a closed door as a personal insult.</li>
          </ul>
        </div>
      </div>
    </section>
  ...
  <footer class="foot">
    ...
    doc = (head("Noa Barzelay",
           ...
           + "\n" + body + "\n")
    doc = doc.replace("<body>", "<!-- subhead (honest, no lab/research overclaim) options: A1 I love turning what AI makes possible into products people trust. | A2 I love turning powerful AI into products people can trust. | A3 I love turning complex technology into products people rely on. | A4 I love building products on top of powerful AI, the kind people actually trust. -->\n<body>", 1)
