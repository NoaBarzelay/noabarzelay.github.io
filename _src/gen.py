    ...
    <section id="projects" class="block">
      ...
      <div class="cards">
        ...
        <article class="card">
          <div class="card-top">
            <h3>Precept</h3>
            <div class="taglist"><span class="pill">TypeScript</span><span class="pill">Claude Code</span><span class="pill">Local-first</span><span class="pill">Evals</span><span class="pill">Obsidian</span></div>
          </div>
